  ...
  return (
    <AppShell pageTitle="Invoice Details">
      ...
      <div className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-8 space-y-6">
        ...
        {/* Invoice Items Table placeholder */}
        ...
        <div className="ml-auto w-full max-w-sm space-y-2 pt-2">
          ...
          <div className="flex justify-between border-t border-slate-200 pt-2"><Skeleton className="h-5 w-24" /><Skeleton className="h-5 w-24" /></div>
        </div>
      </div>
    </AppShell>
  );
