  ...
  return createPortal(
    <div className="animate-fade-in fixed inset-0 z-[90] flex items-end justify-center bg-[#020617]/75 p-0 backdrop-blur-sm sm:items-center sm:p-4">
      ...
      >
        ...
        {/* E. Export footer */}
        <div className="border-t border-slate-200 bg-[#fff] px-4 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] dark:border-white/[0.06] dark:bg-slate-900 sm:px-5 sm:pb-3">
