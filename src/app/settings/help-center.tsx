...
import { Mail, MessageSquare, Info, Shield, FileText, ArrowRight } from "lucide-react";
...
export function HelpCenter() {
  const whatsappUrl = "https://wa.me/923104666026?text=Hi%20there%2C%20Fardan.";
    ...
    <div className="space-y-5">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-6">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="text-sm font-black text-slate-950 dark:text-slate-50">Support Channels</h3>
        </div>
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <a
            ...
            aria-label="Email support at fardan.aatir@outlook.com"
            className="flex h-14 items-center justify-center gap-3 rounded-2xl bg-slate-900 text-white font-bold transition hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 shadow-md hover:shadow-lg active:scale-[0.98] cursor-pointer"
          >
          ...
          <a
            ...
            aria-label="Call support at +923104666026"
            className="flex h-14 items-center justify-center gap-3 rounded-2xl bg-slate-900 text-white font-bold transition hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 shadow-md hover:shadow-lg active:scale-[0.98] cursor-pointer"
          >
            <svg className="w-5 h-5 fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a
            ...
            aria-label="Text support via SMS at +923104666026"
            className="flex h-14 items-center justify-center gap-3 rounded-2xl bg-slate-900 text-white font-bold transition hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 shadow-md hover:shadow-lg active:scale-[0.98] cursor-pointer"
          >
            <svg className="w-5 h-5 fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Social Media Grid */}
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-6">
        <h4 className="text-sm font-black text-slate-950 dark:text-slate-50 border-b border-slate-100 pb-2 dark:border-slate-800 mb-4">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {socialLinks.map((social) => (
            <a
              ...
              className={`flex items-center gap-2.5 rounded-xl border border-slate-200 p-3 text-slate-600 transition duration-200 ${social.bgColor} dark:border-slate-800 dark:text-slate-300 dark:hover:border-transparent cursor-pointer`}
            >
              {social.icon}
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-6">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="text-sm font-black text-slate-950 dark:text-slate-50">Quick Reference Pages</h3>
        </div>
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-2">
          ...
          <Link
            href="/data-deletion"
            className="flex items-center justify-between rounded-xl border border-slate-100 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-800 dark:text-slate-300 dark:hover:bg-slate-800 sm:col-span-2"
          >
            <span className="flex items-center gap-2">
              <FileText className="size-4 text-slate-400" />
