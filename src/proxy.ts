...
export async function proxy(request: NextRequest) {
  try {
    ...
    const directives = [
      "default-src 'self'",
      `script-src 'self' 'nonce-${nonce}' 'strict-dynamic'${isDev ? " 'unsafe-eval'" : ""} https://www.google.com https://www.gstatic.com https://www.googletagmanager.com https://www.google-analytics.com https://*.clarity.ms https://connect.facebook.net https://static.cloudflareinsights.com`,
      ...
      "connect-src 'self' https://bvxyxrdskjryepwjmsvc.supabase.co wss://bvxyxrdskjryepwjmsvc.supabase.co https://accounts.google.com https://www.google-analytics.com https://stats.g.doubleclick.net https://*.clarity.ms https://*.bing.com https://www.facebook.com https://cloudflareinsights.com",
