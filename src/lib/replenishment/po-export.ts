...
<body>
  <div class="wrap">
    ...
    ${meta.quotedTotalLabel ? `<div class="total">Quoted total: ${xmlEscape(meta.quotedTotalLabel)}</div>` : ""}

    <div class="foot">Generated by SaleDock Cloud POS &middot; ${xmlEscape(meta.dateLabel)}</div>
  </div>
</body></html>`;
