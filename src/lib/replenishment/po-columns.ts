...
export function buildExportColumns(showCosts: boolean, currency: string): ExportColumn[] {
  const base: ExportColumn[] = [
    ...
    { key: "minimumStock", header: "Min", type: "number" },
    { key: "targetStock", header: "Target", type: "number" },
    { key: "quantity", header: "Suggested order", type: "number" },
...
export function buildPoColumns(currency: string): ExportColumn[] {
  return [
    ...
    { key: "unitPrice", header: `Unit price (${currency}, quoted)`, type: "number" },
    { key: "lineTotal", header: `Line total (${currency}, quoted)`, type: "number" },
