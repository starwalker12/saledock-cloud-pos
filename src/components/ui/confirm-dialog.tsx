              ...
              <div className="min-w-0 flex-1 space-y-3">
                ...
                <div className="flex flex-col-reverse gap-2 pt-1 sm:flex-row sm:justify-end">
                  ...
                  <button
                    ...
                    className={`motion-press min-h-11 rounded-xl px-4 py-2 text-sm font-black transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#f8fafc] dark:focus:ring-offset-[#0f172a] ${
                      isDestructive
